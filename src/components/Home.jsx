  ...
  return (
    <div className="pt-16 sm:pt-20">
      ...
      <div className='relative'>
        ...
        <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white px-4 pt-24 sm:pt-32 md:pt-36 lg:pt-20">
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">
            DEN MOBILA <br /> CYKELVERKSTADEN</h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl">
            FÅ DIN LÅDCYKEL/CYKEL SERVAD DIREKT PÅ PLATS ELLER I VÅR<br /> BUTIK I MALMÖ
          </p>
        </div>
      </div>
